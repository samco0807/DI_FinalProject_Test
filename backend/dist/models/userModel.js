...
const _getUserByName = (name) => __awaiter(void 0, void 0, void 0, function* () {
    return (0, knex_1.default)("users").where({ name }).first();
});
exports._getUserByName = _getUserByName;
// Function to create new user
const _createUser = (userData) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const [newUser] = yield (0, knex_1.default)("users").insert(userData).returning("*");
        return newUser;
    }
    catch (error) {
...
const _updateUser = (id, userData) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const [updateUser] = yield (0, knex_1.default)("users")
            .where({ id })
            .update(userData)
            .returning("*");
        return updateUser;
...
const _deleteUser = (id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const [deletedUser] = yield (0, knex_1.default)("users")
            .where({ id })
            .del()
            .returning("*");
        return deletedUser;
